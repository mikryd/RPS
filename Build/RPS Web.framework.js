...
var ASM_CONSTS = {
  3038016: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3038077: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3038141: function() {return Module.webglContextAttributes.powerPreference;},  
 3038199: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3038254: function($0) {performance.now = function() { return $0; };},  
 3038302: function($0) {performance.now = function() { return $0; };},  
 3038350: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _emscripten_resize_heap(requestedSize) {
      ...
      for (var cutDown = 1; cutDown <= 4; cutDown *= 2) {
        ...
        overGrownHeapSize = Math.min(overGrownHeapSize, requestedSize + 536870912 );
